...
namespace RemoteControls
{
    ...
    public sealed partial class BluetoothSerialTerminalPage2 : Page
    {
        ...
        public BluetoothSerialTerminalPage2()
        {
            ...
            Globals.BluetoothSerialTerminalPage2 = this;
            ...
            if (button != null)
            {
                switch ((string)button.Content)
                {
                    case "Disconnect":
                        ...
                        this.buttonDisconnect.Visibility = Visibility.Collapsed;
                        this.buttoncomPortConnect.Visibility = Visibility.Visible;
                        this.buttonSend.IsEnabled = false;
                        this.buttonStartRecv.IsEnabled = false;
                        this.buttonStopRecv.Visibility = Visibility.Visible;
                        this.buttonStopRecv.IsEnabled = false;
                        this.buttonStopRecv.Visibility = Visibility.Collapsed;
                        break;
                    case "Connect":
                        ConnectDevice_Click(null, null);
                        this.buttonDisconnect.Visibility = Visibility.Visible;
                        this.buttoncomPortConnect.Visibility = Visibility.Collapsed;
                        this.buttonStartRecv.IsEnabled = false;
                        this.buttonStopRecv.Visibility = Visibility.Visible;
                        this.buttonStopRecv.IsEnabled = false;
                        this.buttonStopRecv.Visibility = Visibility.Collapsed;
