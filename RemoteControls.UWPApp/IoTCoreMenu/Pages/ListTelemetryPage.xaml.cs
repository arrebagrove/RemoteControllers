...
namespace RemoteControls
{
    ...
    /// </summary>
    public sealed partial class ListRemoteControlsPage : Page
    {
        public ListBox ListItems;
        public ListRemoteControlsPage()
        {
            ...
            RemoteControlAPI.SetListTelemetryPage(this);
        }
            ...
            NavigationEventArgs e)
        {
            ...
            if (typ == "string".GetType().ToString())
            {
                ...
                {
                    ShowProgress(true);
                    await Globals.RemoteControlAPI.RefreshTelemetryItems();
                    ShowProgress(false);
                }
                else if (param == "")
                {
            ...
            else if (typ == 137.GetType().ToString())
            {
                ...
                ShowProgress(true);
                await Globals.RemoteControlAPI.RefreshTelemetryHistory(cmd);
                ShowProgress(false);
            }
        }
